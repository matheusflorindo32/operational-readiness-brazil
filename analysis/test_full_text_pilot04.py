...
WB = ROOT / "outputs/full-text/2026-09-20/Operational_Readiness_Full_Text_Pilot_04.xlsx"
...
class Pilot04Regression(unittest.TestCase):
    ...
    def test_workbook_hash(self):
        w=json.loads((P/"workbook-artifact.json").read_text(encoding="utf-8"))
        self.assertTrue(WB.exists())
        self.assertEqual(hashlib.sha256(WB.read_bytes()).hexdigest(), w["binary_sha256"])
